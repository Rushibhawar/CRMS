...
public class JobDao {
	...
	public int insertApplyJobForm(ApplyJobFormApplication applyJobForm){
		...
		try{
			...
			ps.setInt(8, applyJobForm.getStudentId());
			rs=ps.executeUpdate(); 
	...
	public ResultSet getAllAppliedJobDetailsForStudentId(int student_id) {
		ResultSet rs = null;
		try {
			Connection con = ConnectionProvider.getMysqlConnection();
	...
	public int getAllAppliedJobCountForStudentId(int student_id) {
		int count = 0;
		ResultSet rs = null;
		try {
			Connection con = ConnectionProvider.getMysqlConnection();
