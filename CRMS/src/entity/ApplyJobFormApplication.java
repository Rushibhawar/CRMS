...
public class ApplyJobFormApplication {
	...
	public ApplyJobFormApplication(String applied_job_title,
			String applied_job_company, String applied_job_student_name,
			String applied_job_student_email, String applied_job_student_phone,
			String applied_job_student_about, int jobId, int studentId) {
		super();
