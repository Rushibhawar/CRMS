			...
			<h1>Admin LogIn<span class="fa fa-user-plus ml-2"></span> </h1>
			  ...
			  <div class="row mt-4 mb-4">
			    <div class="col form-group">
			    	...
			    	<input type="text" class="form-control" placeholder="Admin name" name="adminName" id="adminName" pattern="[a-zA-Z]*" oninvalid="setCustomValidity('Please enter alphabets only. ')"  maxlength="20" required >
			    </div>
