						    ...
						    <thead class="bg-info text-white">
						     ...
						     <%
						      ...
						      <tr class="table-info"	>
						        ...
						        <td>
						        	<a href="DeleteApplyJobFormServlet?applied_job_id=<%=applied_job_id %>&studentId=<%=student_id %>&studentName=<%=applied_job_student_name %>"><button type="button" class="btn btn-danger" >Delete</button></a>
						        </td>
						      </tr>
						      <%
								}
						    ...
						    <tbody>
						     <%
						      ...
						      <tr class="table-info"	>
						        ...
						        <td>
						        	<a href="applyJobForm.jsp?jobId=<%=jobId %>&jobCompany=<%=jobCompany %>&jobTitle=<%=jobTitle %>&studentId=<%=studentId%>&studentName=<%=studentName%>"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#applyModal">Apply</button></a>
						        </td>
						      </tr>
						      <%
								}
