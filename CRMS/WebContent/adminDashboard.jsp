		...
		<nav class="navbar navbar-expand-lg  navbar-dark bg-dark ml-3 mr-3" >
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav ">
			  ...
			  <li class="nav-item">
		        <a class="nav-link " href="#viewCoordinators">View Coordinator</a>
		      </li>
			 ...
			 <thead class="bg-info text-white">
						    ...
						    <tbody>
						      ...
						      <tr class="table-info"	>
						        ...
						        <td><a href="DeleteCoordinatorServlet?coordinator_name=<%=coordinator_name %>&coordinator_id=<%=coordinator_id %>"><button type="button" id="deleteCoordinatorServlet" class="btn btn-danger">Delete</button></a></td>
						      </tr>
						      <%
								}
						    %>
