...
<body>
	...
	<%@include file="navbar.jsp" %>
			...
			<div class="alert alert-success" role="alert" id="successfully-registered">
			  ...
			  <div class="row mt-4 mb-4">
			    <div class="col form-group">
			    	...
			    	<input type="text" class="form-control" placeholder="Eter User name" name="userName" id="CompanyName" pattern="[a-zA-Z]*" oninvalid="setCustomValidity('Please enter alphabets only. ')"  maxlength="20" >
			    </div>
				...
				<div class="mt-4 mb-4 form-group">
	      		...
	      		<input type="password" class="form-control" id="password" name="inputpassword" placeholder="Enter password"  maxlength="12">
	 ...
	 < <script >
	 function submitForm() {
		 var firstName = document.forms["myForm"]["CompanyName"].value;
		
		
		 var inputpassword = document.forms["myForm"]["password"].value;
