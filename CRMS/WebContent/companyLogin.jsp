 ...
 -->			
			  ...
			  <div class="row mt-4 mb-4">
			    <div class="col form-group">
			    	...
			    	<input type="text" class="form-control" placeholder="Eter User name" name="coordinatorName" id="coordinatorName" pattern="[a-zA-Z]*" oninvalid="setCustomValidity('Please enter alphabets only. ')"  maxlength="20" required>
			    </div>
