			...
			<h1>Coordinator Registration From<span class="fa fa-user-plus ml-2"></span> </h1>
			  <div class="row mt-4 mb-4">
				...
				<div class="mt-4 mb-4 form-group">
	      		...
	      		<input type="password" class="form-control" id="inputpassword" name="inputPassword" placeholder="Enter password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" oninvalid="setCustomValidity('Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters ')"  maxlength="12" required>
